...
\title[Integrating logical constrains in OCGNN for AD]{Integrating logical constrains \\in one-class graph neural networks for anomaly detection}
\subtitle{}
...
\begin{frame}{Motivation of constrains driven graph AD}
